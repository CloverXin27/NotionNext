...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个打工人, Hi，我是一个程序员,Hi，我是一个科技爱好者,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'CloverXin27', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '科技爱好者⭐', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xin27.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '863309096@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/CloverXin27', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  COMMENT_UTTERRANCES_REPO:
    process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'CloverXin27/NotionNext', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/

  // giscus @see https://giscus.app/
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'CloverXin27/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '主页', // 站点描述，被notion中的页面描述覆盖
