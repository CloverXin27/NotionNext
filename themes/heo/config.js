const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    ...
    { title: '开始一件事最好的时间是十年前，其次就是现在。✨', url: 'https://www.xin27.cn/' }
  ],
  ...
  HEO_INFO_CARD_URL2: 'https://github.com/CloverXin27',
  ...
  HEO_SOCIAL_CARD_TITLE_1: '建站教程',
  HEO_SOCIAL_CARD_TITLE_2: '使用NotionNext快速建站',
  HEO_SOCIAL_CARD_TITLE_3: '点击打开建站教程',
  HEO_SOCIAL_CARD_URL: 'https://www.tangly1024.com/',
